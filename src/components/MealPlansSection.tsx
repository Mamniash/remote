	...
	const benefits = [
		{
			...
			description:
				'Ваша аптечка собирается под ваши нужды\u00A0и\u00A0аллергии'
		},
		{
			title: 'Спокойствие',
			description:
				'Всё под рукой в любой момент, в том числе ночью даже\u00A0чат\u00A0со\u00A0врачом.'
		},
		{
			title: 'Безопасность',
			description:
		...
		},
		{
			title: 'Удобство',
			description:
				'Напоминаем о замене и обновляем комплект каждые\u00A03\u00A0месяца.'
		}
	]

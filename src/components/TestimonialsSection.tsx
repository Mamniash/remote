...
const testimonials = [
	{
		...
		text: 'Спокойна за ребёнка, всё всегда под рукой и в срок!',
		tag: 'Безопасно и спокойно'
	},
	{
		name: 'Игорь, 32 года',
		// subtitle: 'пробовал разные диеты',
		text: 'Переживать о лекарствах больше не нужно — всё решается через чат.',
		tag: 'Стабильность и надежность'
	},
	{
		name: 'Ольга, 29 лет',
		// subtitle: 'следит за диетой',
		text: 'Удобно и быстро. Инструкции помогли ночью, когда была температура.',

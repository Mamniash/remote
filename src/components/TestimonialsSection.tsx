...
const testimonials = [
        {
                name: 'Анна, HRBP',
                text: '«После запуска онбординг-сценария новые сотрудники стали выходить на продуктивность на две недели раньше.»',
                tag: 'Онбординг 101'
        },
        {
                name: 'Дмитрий, тимлид разработки',
                text: '«Анти-силос-сценарий объединил разработку и маркетинг: совместные встречи ускорили релиз новой функции.»',
                tag: 'Анти-силос'
        },
        {
                name: 'Екатерина, People Ops',
                text: '«Отчёты системы показали, что отдел продаж подключается лишь в 60% встреч, и мы запустили программу мотивации.»',
                tag: 'Аналитика'
        }
]

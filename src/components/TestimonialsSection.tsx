...
const testimonials = [
	{
		name: 'Ольга, мама 2-летнего Максима',
	...
	{
		name: 'Екатерина, мама 3-летнего Ильи',
		// subtitle: 'пробовал разные диеты',
		text: 'Удобный сервис: я забыла обновить аптечку, а приложение напомнило о просроченных препаратах. Заказ пришёл на следующий день!',
		tag: 'Стабильность и надежность'
	},
	{
		name: 'Ирина, мама 1-летней Анечки',
